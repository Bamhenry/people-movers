...
public class NVPAPICaller
{
    ...
    public string APIUsername = "peoplemoversdeveloper-facilitator_api1.live.com";
    private string APIPassword = "YAFMX3CXLYH4FJ3X";
    private string APISignature = "ADuT2ajKnj6rag59Cg9a2LR9msyTAPEjs-pIde1UoZI2z-z.2PbZnr53";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        using (PeopleMovers.Logic.ShoppingCartActions myCartOrders = new PeopleMovers.Logic.ShoppingCartActions())
        {
    ...
    public string HttpCall(string NvpRequest)
    {
        ...
        {
            // Log the exception.
            PeopleMovers.Logic.ExceptionUtility.LogException(e, "HttpCall in PayPalFunction.cs");
        }
